...
def parse_option():
    ...
    parser.add_argument("--exemplar_features_path", type=str, default="/features/mnist_resnet18_original_data__mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_no_SimCLR_1.0_1.0_0.05_trail_0_128_256_20_train")
    parser.add_argument("--testing_known_features_path", type=str, default="/features/mnist_resnet18_original_data__mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_no_SimCLR_1.0_1.0_0.05_trail_0_128_256_20_test_known")
    parser.add_argument("--testing_unknown_features_path", type=str, default="/features/mnist_resnet18_original_data__mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_no_SimCLR_1.0_1.0_0.05_trail_0_128_256_20_test_unknown")
